...
const Essentials = () => {
  ...
  return (
    <div data-aos="zoom-in-up" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" className="flex justify-center items-center flex-col gap-8 px-3 pt-5 m-2 xl:px-15 xl:py-8 xl:m-4 select-none">
      ...
      <div className="xl:px-16 lg:px-8 w-full relative">
        <div className="absolute left-4 lg:left-20 xl:left-20 z-10 top-0 bottom-0 flex justify-center items-center">
          <div
            onClick={() => {
        ...
        <div className="absolute right-4 lg:right-20 xl:right-20 z-10 top-0 bottom-0 flex justify-center items-center">
          <div
            onClick={() => {
