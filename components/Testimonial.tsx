  ...
  return (
    <div className="flex justify-center items-center flex-col gap-8 px-3 pt-5 mt-2 xl:px-15 xl:py-8 xl:mt-4 select-none bg-testimonialsBg">
      ...
      <div className="flex w-full flex-row justify-center items-center xl:px-16 lg:px-8 pb-8 relative">
        <div className="absolute -left-2 lg:left-28 xl:left-28 z-10 top-0 bottom-0 flex justify-center items-center">
          <div
            onClick={() => {
        ...
        <div className="absolute -right-2 lg:right-28 xl:right-28 z-10 top-0 bottom-0 flex justify-center items-center">
          <div
            onClick={() => {
