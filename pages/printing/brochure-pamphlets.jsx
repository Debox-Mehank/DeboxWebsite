...
const BrochurePamphlets = () => {
    ...
    return (
        <div className=''>
            ...
            <form name="contact23" data-netlify="true" action="/contact?submit=true" method="POST" className="w-full px-8 lg:px-20 xl:px-20 py-4 lg:py-0 xl:py-0 flex flex-col justify-center gap-6">
